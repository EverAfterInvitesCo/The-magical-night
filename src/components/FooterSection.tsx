...
export const FooterSection: React.FC = () => {
  return (
    <footer className="relative z-10 py-10 px-4 border-t border-[#d4af37]/30 bg-gradient-to-b from-transparent via-[#f5f0e6]/50 to-[#ebdcc2]/60 text-center font-tajawal">
      <div className="max-w-xl mx-auto flex flex-col items-center justify-center gap-4">
        {/* Made with love statement */}
        <p className="text-base sm:text-lg font-semibold text-[#5a461b]">
          Made with love by <span className="text-[#8c6d1d] font-bold">everafterinvites</span>
        </p>
        ...
        <div className="flex items-center justify-center gap-5 mt-1">
          ...
          <a
            ...
            className="w-10 h-10 rounded-full border border-[#d4af37]/60 bg-white/80 hover:bg-[#d4af37] text-[#8c6d1d] hover:text-[#0A1128] transition-all flex items-center justify-center shadow-xs cursor-pointer group"
          >
            <svg
